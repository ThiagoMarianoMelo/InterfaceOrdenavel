...
public class Data implements Ordenavel{
    ...
    public boolean menorQue(Ordenavel o){
        ...
        Data conversorData = ((Data) o) ;

        boolean anoIgual = this.getAno() == conversorData.getAno();

        boolean mesIgual = this.getMes() == conversorData.getMes();

        boolean diaIgual = this.getDia() == conversorData.getDia();
        ...
        if(anoIgual){
            if(mesIgual){
                if(diaIgual){
                    ...
                    return this.getDia() < conversorData.getDia();
                }
            }else{
                return this.getMes() < conversorData.getMes();
            }
        }else{
            return this.getAno() < conversorData.getAno();
        }
    }
